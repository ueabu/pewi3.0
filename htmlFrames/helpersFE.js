...
//Function to close download frame 
function toggleDownloadFrame(){
    if (document.getElementById('uploadDownloadHolder').style.display == "block" && modalUp ){
        document.getElementById('uploadDownloadHolder').style.display == "none";
        document.getElementById('downloadTable').style.visibility == "hidden";
    }
}
